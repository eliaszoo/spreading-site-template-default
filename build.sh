...
then
    ...
    echo "test"
    aws apigateway create-domain-name --domain-name test3.spreading.io --certificate-arn arn:aws:acm:ap-southeast-1:547537176727:certificate/3737d1ce-54b7-411f-9e2b-659781a8e7a8 --region ap-southeast-1
